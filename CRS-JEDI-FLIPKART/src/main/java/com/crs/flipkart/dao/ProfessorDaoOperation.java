...
public class ProfessorDaoOperation implements ProfessorDaoInterface {
    ...
    @Override
    public List<Pair<PersonalDetails,String>> getEnrolledStudents(String courseId)  {
        Connection conn = null;
        PreparedStatement prep_stmt = null;
        try {
            conn = DBUtils.getConnection();
            ...
            ResultSet result = prep_stmt.executeQuery();
            List<Pair<PersonalDetails,String>> students = new ArrayList<>();
            while (result.next()) {
                ...
                students.add(new Pair<>(studentDetails, rollNo));
            }
            return students;
        } catch (SQLException se) {
            logger.error(se.getMessage());
    ...
    public Boolean giveGrades(String studentid, String profId, String courseId, String grade)  {
        ...
        try {
            ...
            List<Pair<PersonalDetails,String>> students = getEnrolledStudents(courseId);
